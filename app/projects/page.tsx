...
const projects = [
  ...
  },
  {
    ...
    filter: "AI & PRODUCTS",
    year: "2025",
    focus: "Interpretable classification",
    image: "/assets/projects/ai-art-detector.png",
    description:
      "Distinguishes AI-generated art from human-made pieces using deep CNNs and interpretable visualizations.",
  ...
  },
  {
    ...
    tags: ["Robotics", "ROS", "HRI"],
    metric: "3×",
    metricLabel: "faster targeting",
    href: "https://github.com/Lareina-Y/HRI-Tom-Target",
  },
  {
    name: "Ticket Viewer",
    ...
    year: "2026",
    focus: "GIS conflict analysis",
    image: "/assets/projects/ticket-viewer.png",
    description:
      "Maps infrastructure tickets and exposes spatial conflicts before they become field delays.",
    tags: ["GIS", "React", "Node.js"],
    metric: "1 view",
    metricLabel: "for every conflict",
  ...
  },
  {
    ...
    filter: "AI & PRODUCTS",
    year: "2025",
    focus: "3D room recommendations",
    image: "/assets/projects/livinit.png",
    description:
      "Creates personalized 3D room recommendations from a space, style, and everyday needs.",
    tags: ["SwiftUI", "3D", "AI"],
    metric: "360°",
    metricLabel: "room preview",
    href: "https://github.com/Lareina-Y/Livinit",
  },
  {
    name: "STRICT++",
    category: "Research",
    filter: "RESEARCH",
    year: "2024",
    focus: "946 change requests",
    image: "/assets/projects/strict-plus-plus.png",
    description:
      "Studies change-request patterns to make large-scale software evolution easier to understand.",
    tags: ["Research", "NLP", "Mining"],
    metric: "946",
    metricLabel: "requests analyzed",
  ...
  },
  {
    ...
    description:
      "Improves time-slotted channel hopping for reliable, efficient industrial wireless networks.",
    tags: ["Networks", "IoT", "TSCH"],
    metric: "IEEE",
    metricLabel: "GLOBECOM",
    href: "https://github.com/Lareina-Y/tsch-project",
  },
  {
    ...
    tags: ["XR", "Unity", "3D"],
    metric: "6DoF",
    metricLabel: "spatial creation",
    href: "https://github.com/Lareina-Y/Mini-Gravity-Sketch",
  },
] satisfies Array<{
  name: string;
  category: string;
