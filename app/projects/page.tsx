...
const projects = [
  { name: "TaskMosaic", category: "AI & Products", filter: "AI & PRODUCTS", year: "2025", focus: "AI task planning", image: "/assets/projects/taskmosaic.png", description: "Turns complex goals into clear, adaptive task plans with AI-assisted prioritization.", tags: ["React", "AI", "Product"], metric: "40%", metricLabel: "faster planning", href: "https://github.com/Lareina-Y/TaskMosaic" },
